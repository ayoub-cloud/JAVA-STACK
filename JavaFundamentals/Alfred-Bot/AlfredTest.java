public class AlfredTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(alfredBot.angryResponse("You are so annoying"));
        
        // NINJA BONUS: Testing the overloaded guestGreeting method
        System.out.println(alfredBot.guestGreeting("John Doe", "morning"));
    }
}
